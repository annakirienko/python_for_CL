...
for author in authors:
    ...
    if unique_words_count > max_count:
        max_count = unique_words_count
        best_author = author

print("Best author: %s" % best_author)
print("Best author's words count: %s" % max_count)
